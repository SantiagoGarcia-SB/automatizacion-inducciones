 ...
 *
 * @deprecated Reemplazada por sincronizarUnificado() en Sincronizacion_Unificada.js.
 *             Esta función se conserva temporalmente para rollback. El trigger asociado
 *             fue eliminado — usar configurarTriggerSincronizacionUnificada() para configurar
 *             el nuevo trigger unificado que ejecuta sincronizarUnificado() cada 10 minutos.
 */
...
function _notificarCambiosEstadoComerciales_(cambiosPorLote) {
  ...
  for (var idLote in cambiosPorLote) {
    ...
    var nombreComercial = emailANombre(emailComercial, 'PRIMER_NOMBRE') || 'Ejecutivo Comercial';
